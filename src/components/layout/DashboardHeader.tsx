...
export const DashboardHeader = () => {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 border-b-4 border-blue-500 bg-white shadow-sm relative z-50">
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="border-l border-gray-300 pl-6">
            <h1 className="text-xl font-bold text-gray-900">IT Delivery Summary Dashboard</h1>
            <p className="text-sm text-gray-600">Executive overview of project delivery health and performance</p>
          </div>
        </div>
      </div>
