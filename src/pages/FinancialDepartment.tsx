...
const FinancialDepartment = () => {
  ...
  // You can now use getCurrentDateRange() to filter financial data based on selected period
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <KPICard
          ...
          value={formatCurrency(kpis.totalSOWValue)}
        ...
        <KPICard
          ...
          value={formatCurrency(kpis.projectActuals)}
          trend={{ value: formatPercentage((kpis.projectActuals/kpis.totalSOWValue)*100) + " of SOW", isPositive: true }}
          icon={TrendingUp}
          iconColor="text-blue-500"
        />
        <KPICard
          title="Bench Cost (Monthly)"
          value={formatCurrency(kpis.benchCostMonthly)}
          trend={{ value: `${benchResources.totalBenchResources} resources on bench`, isPositive: false }}
          icon={Users}
          iconColor="text-orange-500"
        />
        <KPICard
          title="Overall Margin"
          value={formatPercentage(kpis.overallMargin)}
          trend={{ value: kpis.overallMargin > 20 ? "Healthy margin" : "Monitor closely", isPositive: kpis.overallMargin > 20 }}
          icon={TrendingUp}
          iconColor={kpis.overallMargin > 20 ? "text-green-500" : "text-red-500"}
        />
      </div>
        ...
        <TabsContent value="projects" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">
                  {Math.round(kpis.avgUtilization)}%
                </div>
              ...
              <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-bold text-yellow-800">-{formatPercentage((benchResources.monthlyCost * 12) / kpis.totalSOWValue * 100)}</div>
                  </div>
                  <div>
